...
#ifndef PROCEDURAL_PROGRAMMING_SRC_CREATE_TXT_FILE_H_
#define PROCEDURAL_PROGRAMMING_SRC_CREATE_TXT_FILE_H_
...
#endif  // PROCEDURAL_PROGRAMMING_SRC_CREATE_TXT_FILE_H_
